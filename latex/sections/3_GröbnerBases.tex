...
\input{subsections/3_DicksonsLemma.tex}

\subsection{Hilbert Bases Theorem}
\input{subsections/3_HilbertBases.tex}

\subsection{Gröbner Bases}
\input{subsections/3_GröbnerBasis.tex}

\subsection{Properties of Gröbner Bases}
\input{subsections/3_PropertiesOfGröbnerBasis}