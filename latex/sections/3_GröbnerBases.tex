...
Here the results that monomial ideals have finite generators is extended to polynomial ideals. The basic idea is that by rearranging the ideal to a monomial ideal using the leading term, we can apply the Dicksons lemma. This will also solve the ideal description problem. 
\subsubsection{Hilbert Bases Theorem}
...
\input{subsections/GröbnerBases/3_PropertiesOfGröbnerBasis}