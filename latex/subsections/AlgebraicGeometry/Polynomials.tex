...
A \textbf{monomial} in $\vectorComponents{x}$ is a product of the form
    ...
    \end{equation}
where all $ \alpha = \alpha_1,...,\alpha_n$ are nonnegative integers.
\end{definition}
